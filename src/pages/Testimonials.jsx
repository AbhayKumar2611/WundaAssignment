...
export default function Testimonials() {
  ...
  return (
    <section className="section py-16 px-[7vw]" style={{ fontFamily: 'var(--font-sans)' }}>
      <h2 className="text-3xl sm:text-3xl font-semibold text-center text-gray-900 dark:text-white" style={{ fontFamily: 'var(--font-sans)' }}>What Our Users Say</h2>
